               ...
               <div class="col-lg-12">
                   <div class="ibox float-e-margins">
                       ...
                       <div class="ibox-content">
                           <form method="POST" action="/admin/manage/user/update" class="form-horizontal">
                                 {{ csrf_field() }}
                                 ...
                                 <div class="form-group"><label class="col-sm-2 control-label">role</label>
                                     <div class="form-group">
                                       <select name="role_id">
                                         ...
                                         <option value="{{$roles->id}}"@if(isset($users->role_id)&&($users->role_id == $roles->id)) selected @endif>{{$roles->role}}</option>
                                         @endforeach
                                       </select>
                                     </div>
                                </div>
